...
import com.example.Kirokhada.findmate.data.RWriteInfo;
...
public class RWritePostActivity extends AppCompatActivity {
    private static final String Tag = "RWritePostActivity";
    ...
    private void init() {
        ...
        upload_btn = findViewById(R.id.r_upload_button);

        View titleLayout = findViewById(R.id.r_title_Layer);
        View timeLayout = findViewById(R.id.r_time_Layer);
        View placeLayout = findViewById(R.id.r_place_Layer);
        View memberLayout = findViewById(R.id.r_memberCount_Layer);
        ...
        contentEditText = findViewById(R.id.r_content_Edit);
    ...
    private void setting() {
        ...
        timeTextView.setText("방문 날짜 :");
        placeTextView.setText("상호명 :");
        memberCountTextView.setText("방문 인원 수 :");
    }
