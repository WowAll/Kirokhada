package com.example.Kirokhada.findmate.fragment;
...
import com.example.Kirokhada.findmate.activity.RWritePostActivity;
import com.example.Kirokhada.findmate.data.RBordAdapter;
import com.example.Kirokhada.findmate.data.RBordInfo;
...
public class ReviewFragment extends Fragment {
    ...
    private RBordAdapter bordAdapter;
    ...
    ArrayList<RBordInfo> getDataList = new ArrayList<>();
    ...
    public void fabAction() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), RWritePostActivity.class);
    ...
    public void recyclerViewAction() {
        ...
        bordAdapter = new RBordAdapter(getActivity());
        ...
        db.collection("review").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    List<RBordInfo> resultData = task.getResult().toObjects(RBordInfo.class);
                    ...
                    // 정렬 해보자
                    Collections.sort(getDataList, new Comparator<RBordInfo>() {
                        @Override
                        public int compare(RBordInfo o1, RBordInfo o2) {
