...
public class RbordActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_re_board);
    ...
    private void init() {
        ...
        circleImageView = findViewById(R.id.r_userProfile_s);
        title = findViewById(R.id.r_title_textView);
        name = findViewById(R.id.r_userName_s);
        date = findViewById(R.id.r_dateCount);
        place = findViewById(R.id.r_placeText);
        time = findViewById(R.id.r_timeText);
        member = findViewById(R.id.r_memberCountText);
        content = findViewById(R.id.r_contentText);

        titleEdit = findViewById(R.id.r_titleEditText);
        placeEdit = findViewById(R.id.r_placeEditText);
        timeEdit = findViewById(R.id.r_timeEditText);
        memberEdit = findViewById(R.id.r_memberCountEditText);
        contentEdit = findViewById(R.id.r_contentEditText);

        modify_btn = findViewById(R.id.r_modify_btn);
        del_btn = findViewById(R.id.r_del_btn);
        update_btn = findViewById(R.id.r_update_btn);
    }
    ...
    private void userSerVice() {
        ...
        del_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(RbordActivity.this);
                ...
                builder.setPositiveButton("네",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(final DialogInterface dialog, int which) {
                                ...
                                fireStore.collection("review").document(sc).delete()
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!titleUpdate.equals("") && !placeUpdate.equals("") && !timeUpdate.equals("")
                    ...
                    fireStore.collection("review").document(sc).update(upDateMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                    ...
                    time.setText("방문 날짜 : " + timeUpdate);
                    place.setText("상호 명 : " + placeUpdate);
                    member.setText("방문 인원 수 : " + memberCountUpdate);
                    content.setText("내용 : \n\n" + contentUpdate);
    ...
    private void setData() {
        ...
        place.setText("상호명 : " + placeText);
        time.setText("방문 날짜 : " + timeText);
        member.setText("방문 인원 수 : " + memberCountText);
